                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$claasses[$i]->tname}}</td>
                                        <td>{{$claasses[$i]->tid}}</td>
                                        <td>{{$claasses[$i]->class}}</td>
                                        <td>{{$claasses[$i]->subject}}</td>
                                        <td>{{$claasses[$i]->section}}</td>
                                        <td>{{$claasses[$i]->stime}}</td>
                                        <td>{{$claasses[$i]->ftime}}</td>
                                        <td>{{$claasses[$i]->day}}</td>
                                         <td>
                                            <div class="dropdown">
